    ...
    <nav
      className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        isScrolled || isMobileMenuOpen
          ? 'py-4 glass border-b border-green-500/10'
          : 'py-6'
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <a
          href="#about"
          className="text-xl font-bold tracking-tighter flex items-center gap-2 relative z-50 group"
        >
          <div className="w-9 h-9 rounded-full overflow-hidden border-2 border-green-500 shadow-md group-hover:scale-110 transition-transform">
            <img
              src="https://im.ge/i/10000216194.GFxbiq"
              alt="Habeebullah Sulyman"
              className="w-full h-full object-cover"
            />
          </div>
          <span className="inline group-hover:text-green-400 transition-colors">
            Habeebullah.dev
          </span>
        </a>
